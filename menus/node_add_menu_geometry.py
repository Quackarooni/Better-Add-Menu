...
from .utils import draw_asset_menu, add_separator, ColumnMenu
...
class NODE_MT_category_GEO_UTILITIES(ColumnMenu, Menu):
    ...
    def draw(self, _context):
        ...
        self.draw_column(layout, menus=(NODE_MT_category_GEO_TEXT,))
        self.draw_column(layout, menus=(NODE_MT_category_GEO_UTILITIES_MATH, NODE_MT_category_GEO_UTILITIES_FIELD,))
        col = self.draw_column(layout, menus=(NODE_MT_category_GEO_UTILITIES_ROTATION,))
